...
// const getMovieRate=movies.filter(function(movie){
// return movie.rating>=4
// })
// const movieDirected =movies.filter(function(movie){
//     return (movie.director.toLowerCase() ==="Tom Cruise.toLowerCase()")
// })
// const movieId=movies.find(function(movie) {
//    return movie.id ===3
// });
// const movieRated=movies.filter(function(movie){
//     return movie.rating<4
// })
// const searchMovie=(function(searchTerm){
